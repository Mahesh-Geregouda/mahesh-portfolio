      ...
      <div className="container">
        <div className={`hero-content ${isVisible ? 'visible' : ''}`}>
          <div className="hero-text">
            ...
            <h1 className="hero-name">Mahesh</h1>
            <h2 className="hero-title">
              <span className="title-line">Data Analyst</span>
              <span className="title-separator">&</span>
              <span className="title-line">Data Engineer</span>
            </h2>
            <p className="hero-description">
              Transforming raw data into actionable insights and building robust data pipelines
              that drive business decisions. Passionate about data visualization, analytics,
          ...
          <div className="hero-visual">
            <div className="hero-photo-container">
              ...
              <div className="hero-photo-wrapper">
                <img src={`${process.env.PUBLIC_URL}/profile.png`} alt="Mahesh" className="hero-photo-img" />
              </div>
